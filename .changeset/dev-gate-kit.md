...
Add a dev-only, production-stripped duplicate-registration warning to `define()`.
Registering a *different* custom-element constructor under an already-taken tag
