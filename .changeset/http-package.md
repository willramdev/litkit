---
"@willramdev/http": minor
---

feat(http): new package `@willramdev/http`, a fetch-based HTTP client. It works in any JavaScript environment, with no framework dependency.
